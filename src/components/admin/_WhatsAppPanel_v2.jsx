...
const PLAN_ICONS = { combo_mensal: '\u{1F4C5}', combo_trimestral: '\u{1F4E6}', combo_semestral: '\u{1F3C6}' };
                    ...
                    <div className={cn(
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm font-semibold text-white flex items-center gap-2">
                          {step.type === 'text' ? '\u{1F4AC}' : '\u{1F3A4}'} Passo {i + 1}:
              ...
              <tbody>
                {planKeys.map(key => {
                  ...
                  const fmtSteps = (arr) => {
                    ...
                    const parts = [];
                    if (t) parts.push(`${t}\u{1F4AC}`);
                    if (a) parts.push(`${a}\u{1F3A4}`);
                    return parts.join(' ') || '\u2014';
                  };
                  return (
